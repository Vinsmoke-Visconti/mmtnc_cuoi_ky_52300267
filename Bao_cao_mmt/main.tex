...
TỐI ƯU HÓA BẢO MẬT ĐA LỚP VÀ CÂN BẰNG TẢI\\DỰA TRÊN NGƯỠNG TRONG MÔ HÌNH CAMPUS 3 LỚP}
...
% Chương 1: Tổng quan và Thiết kế Topology
\include{chuongs/chuong1_tongquan_topology}       
\newpage
\clearpage

% Chương 2: Cấu hình Định tuyến OSPF và NAT/PAT
\include{chuongs/chuong2_ospf_nat} 
\newpage
\clearpage

% Chương 3: Triển khai Bảo mật đa lớp
\include{chuongs/chuong3_baomat}
\newpage
\clearpage
	
% Chương 4: Thực nghiệm Cân bằng tải theo ngưỡng
\include{chuongs/chuong4_canbangtai}
\newpage
\clearpage

% Chương 5: Phân tích kết quả và Kết luận
\include{chuongs/chuong5_phantich_ketluan}
\newpage
\clearpage
