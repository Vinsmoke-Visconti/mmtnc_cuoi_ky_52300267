...
echo "  mininet> py exec(open('scripts/nat_acl_test.py').read(), globals()); run_nat_acl_test(net)"
echo ""
echo "  [HIEU NANG]"
echo "  mininet> py exec(open('scripts/performance_test.py').read(), globals()); full_test(net)"
echo ""
echo "  [CAN BANG TAI]"
echo "  mininet> py exec(open('scripts/load_balancer.py').read(), globals()); demo_load_balance(net)"
echo ""
echo "  [OSPF]"
