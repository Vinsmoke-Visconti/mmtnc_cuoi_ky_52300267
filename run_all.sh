...
echo "  mininet> py import scripts.nat_acl_test as nat; nat.run_nat_acl_test(net)"
echo ""
echo "  [HIEU NANG]"
echo "  mininet> py import scripts.performance_test as pt; pt.full_test(net)"
echo ""
echo "  [CAN BANG TAI]"
echo "  mininet> py import scripts.load_balancer as lb; lb.demo_load_balance(net)"
echo ""
echo "  [OSPF]"
